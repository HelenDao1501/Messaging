...
public class MainActivity extends Activity {
    ...
    public static  int status; //0 set default; 1: get feedback; 2: invoke from receiver
    ...
    public void clickToSendSMSIntent(View view) {
        ...
        intent.putExtra("address", "0387392679");
        intent.putExtra("sms_body", "Đừng ngủ nữa");
    ...
    public void clickToSendSMSFB(View view) {
        ...
        registerReceiver(smsSentReceiver, new IntentFilter(SENT));
        registerReceiver(smsDeliveredReceiver, new IntentFilter(DELIVERED));
        sms.sendTextMessage("0387392679", null,
                "Trà sữa hong", sentPI, deliveredPI);
    }
    ...
    public void clickToSendEmail(View view) {
        String[] to = {"teenlonglanh@gmail.com"};
        String[] cc = {"tramdbse140878@fpt.edu.vn"};
